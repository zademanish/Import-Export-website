...
const FeaturesPage = () => {
  return (
    <section className='bg-[#010428]' id='team'>
    ...
    <div className="flex flex-col items-center justify-start min-h-fit  py-8 md:flex-row">
      ...
      {/* Feature Cards */}
      <div className="space-y-6 px-4 w-full max-w-sm md:mx-8 md:flex items-center justify-center gap-8 md:max-w-full">
        ...
        {/* Feature 1 */}
       <div>
        <div className="my-4 flex items-start mx-2 bg-gradient-to-r from-[#090E3F] to-[#010428] md:max-w-lg rounded-lg p-6 md:my-4 md:flex-none">
        ...
        {/* Feature 2 */}
        <div className=" my-4 flex items-start mx-2 bg-gradient-to-r from-[#090E3F] to-[#010428] rounded-lg p-6 md:max-w-lg md:my-4 md:flex-none">
          <div className="flex items-center justify-between  gap-4 ">
            <div>
